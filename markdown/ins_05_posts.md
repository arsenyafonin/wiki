...
!!! warning
    В шаге 2 устаревшая инструкция. С мая 2017-го года изображения для поста делаются через форму запроса графическому дизайнеру.
...
* Запланировать пост `СММ-менеджер`
* Проверить содержание ссылки `Куратор`
