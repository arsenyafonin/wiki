...
Также Wrike является отличным сервисом для повторяющихся рутинных действий. Если вы знаете, что-то какое действие вам приходится делать регулярно, например 1 раз в неделю или в месяц, для него стоит поставить автоматическую задачу во Wrike (как правило в проекте Regular). Для таких задач мы используем возмжности автоматизации сервиса с помощью [Zapier](https://zapier.com/). Подробнее об этой возможности вы можете уточнить у технического администратора.
