...
Таймлайн проекта *Meetings* с привязкой задач к двум ключевым датам можно посмотреть [здесь](https://www.wrike.com/timeline/index.html?id=gJejjME4zpmVjzye27AfB0ckFvGXwebq|IEYTGMJVGA3TGLSTGY).
...
После утверждения сценария продвижения, куратору необходимо резюмировать все действия в проект Promo во Wrike по существующим шаблонам. Подробное видео о том, как это делается, можно посмотреть [здесь](https://vimeo.com/194652911). Оценка работы куратора проиходит с учетом данных из проекта Promo.
